...
function announce(text){
 ...
 const message=/SAM LAUNCH/.test(text)?text.replace('SAM LAUNCH — ','MISSILE · '):/MISSILE INBOUND/.test(text)?text:/RADAR TRACK|SAM TRACK/.test(text)?'SAM TRACKING':/TARGET DESTROYED/.test(text)?'TARGET DESTROYED · EXIT NORTH':null;
 if(!message)return;
