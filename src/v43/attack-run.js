...
const v43VaporMat=new THREE.MeshBasicMaterial({color:0xd8d2c4,transparent:true,opacity:.12,depthWrite:false,fog:true});
for(let i=0;i<7;i++){
 const m=new THREE.Mesh(vaporGeo,v43VaporMat.clone());m.frustumCulled=true;scene.add(m);
