...
function clearSamNetwork(){
 removeSamMissile();
 for(const s of v41.sam.sites)scene.remove(s.group);
...
groundStrikeImpact=function(){
 ...
 v41GroundStrikeBase();
 v41.launch.active=false;v41.launch.destroyed=true;v41.launch.egress=8.5;rocket.visible=false;rocketFlame.visible=false;
...
updateMission=function(dt){
 if(worldIndex===0&&v41.launch.destroyed&&v41.launch.egress>0){
  ...
  if(v41.launch.egress<=0){citySplit=missionElapsed;missionCompleteTimer=.95;}
  return;
 }
 v41MissionBase(dt);
};
